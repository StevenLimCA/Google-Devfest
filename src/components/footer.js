  ...
  <footer className="bg-Grey900 text-white p-10 ">
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 w-11/12 mx-auto">
      <div className="">
        ...
        <p>{process.env.REACT_APP_CHAPTER_ABOUT}</p>
        <a href="https://gdg.community.dev/">
          <img
            src={gdg_logo}
            className="my-3 p-5 bg-white rounded-xl"
            alt="GDG {process.env.REACT_APP_CHAPTER_NAME} logo"
          ></img>
        </a>
      </div>
      <div>
      ...
      <div>
        ...
        <a
          ...
          className="block"
          aria-label={`send email to GDG ${process.env.REACT_APP_CHAPTER_NAME}`}
        >
          {process.env.REACT_APP_DEVFEST_EMAIL}
        </a>
        <ul className="inline-flex space-x-4 text-xl my-4">
          <li>
            <a
              href={process.env.REACT_APP_SOCIAL_WEBSITE}
              aria-label="GDG Chapter Website"
            >
              <FaGlobe />
            </a>
          </li>
          <li>
            <a
              href={
                "https://twitter.com/" + process.env.REACT_APP_SOCIAL_TWITTER
              }
              aria-label="follow GDG {process.env.REACT_APP_CHAPTER_NAME} on Twitter"
            >
              <FaTwitter />
            </a>
          </li>
          <li>
            <a
              ...
              aria-label="follow GDG {process.env.REACT_APP_CHAPTER_NAME} on LinkedIn"
            >
              <FaLinkedin />
            </a>
          </li>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            <Link to="/volunteer" className="text-white">
              Volunteer
            </Link>
          </li>
        </ul>
    ...
    <div className="my-10 text-center">
      <div>
        <span>
          Copyright 2022 Google Developer Groups (GDG){" "}
          {process.env.REACT_APP_CHAPTER_NAME}.
        </span>
      </div>
      <div>
        <span>
          GDG {process.env.REACT_APP_CHAPTER_NAME} is an independent group; our
          activities and the opinions expressed here should in no way be linked
          to Google, the corporation.
        </span>
      </div>
    </div>
  </footer>
